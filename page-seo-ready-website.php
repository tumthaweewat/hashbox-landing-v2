...
$faqs = array(
    ...
    array( 'q' => 'ทำเว็บไซต์สำหรับ SEO ต้องมีอะไรบ้าง?', 'a' => 'พื้นฐาน 5 อย่างที่ต้องมีตั้งแต่วันเปิด: (1) โครงสร้าง URL และ heading ที่ Google อ่านรู้เรื่อง (2) ความเร็วผ่าน Core Web Vitals บนมือถือ (3) Schema Markup ครบตามชนิดหน้า (4) เนื้อหาที่ตอบคำถามหลักของแต่ละหน้าใน 2 บรรทัดแรก (5) เปิดรับ AI crawler + llms.txt สำหรับยุค AI Search — เว็บจาก Hashbox ส่งมอบครบทั้ง 5 ผ่าน Build Gate ก่อน deploy ทุกเคส' ),
