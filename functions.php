 ...
 *
 *   1. Keep robots.txt intentionally small. AI / GEO crawlers inherit
 *      the `User-agent: *` rules, which keeps them allowed on public
 *      content without maintaining a long bot-specific list.
 *
