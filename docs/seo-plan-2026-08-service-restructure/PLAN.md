...
- ⏳ PSI performance (API quota 429 ทั้งวัน — ใช้ pagespeed.web.dev UI ในรอบ 3) · ⏳ GSC request index รอบ 3 เลื่อนเป็น 30 ส.ค. 15:37 (quota หมด 29 ส.ค. 19:50 ตอนส่ง /en/seo/ — rolling 24h)
