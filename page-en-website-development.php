...
$faqs = array(
    ...
    array( 'q' => 'What is the difference between web design and web development?', 'a' => 'Web design is how the site looks and how people move through it — layout, typography, imagery, the path to a quote request. Web development is what makes it run: templates, CMS, schema, performance budgets, integrations. Most web design companies in Bangkok stop at the first half and hand over a build that looks right but scores 30–50 on mobile and ships without schema, so the SEO work starts with repairs. We do both in one team, which is why Lighthouse mobile 95+ and valid schema are a written guarantee here rather than an upsell. Bring a Figma file and we build from it; if you do not have one, design is part of the scope.' ),
