...
แผนรอบนี้เขียนขึ้น **ก่อน** ที่ DataForSEO จะยิงได้ จึงยังไม่มีตัวเลข volume
สิ่งที่ใช้ตัดสินใจแทน:
...
### เติมตัวเลขเมื่อ DataForSEO พร้อม

```bash
node tools/dataforseo.mjs plan seo-handoff/keyword-plan-2026-08.md
```

จะได้ volume · trend · competition · โดเมนที่ยึดหน้า 1 · **และมี AI Overview หรือยัง** ของทั้ง 10 hero รวดเดียว
แล้วค่อยกลับมาจัดลำดับ §4 ใหม่ตามตัวเลขจริง

> **อย่าตัดหัวข้อทิ้งเพราะ volume ต่ำ** — แผนนี้เลือกคำที่ยังไม่มีคนแข่งโดยตั้งใจ volume ต่ำหรือ 0 คือสิ่งที่คาดไว้แล้ว
> ตัวเลขที่ต้องดูคือ `trend` และคำตอบว่า SERP นั้นมี AI Overview แล้วหรือยัง
