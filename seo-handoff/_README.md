...
- `_inventory.md` — keyword ที่แต่ละหน้าจองไว้แล้ว **เช็คไฟล์นี้ก่อนเสนอหัวข้อใหม่ทุกครั้ง** (กันเขียนทับกันเอง) และต้องอัปเดตทุกครั้งที่ publish
- `keyword-plan-2026-08.md` — แผน 10 หัวข้อล่าสุด (SEO + AI Overview สำหรับ 3 สายบริการ) พร้อมลำดับการเขียน · ทำไปแล้ว 4 จาก 10
- `ai-agent-vs-chatbot-insert.md` — เนื้อหาพร้อมวางลงโพสต์เดิม `/ai-agent-rag-chatbot-thailand-2026/` (แก้หน้าเดิม ไม่ใช่เขียนใหม่)
- วิธีหารอบใหม่: สั่ง Claude Code ว่า `/seo-keyword` แล้วบอกสายบริการที่ต้องการ — workflow อยู่ใน `.claude/skills/seo-keyword/`
