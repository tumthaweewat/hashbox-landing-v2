...
$faqs = array(
    ...
    array( 'q' => 'ค้นหาที่ปรึกษา AI ได้ที่ไหน?', 'a' => 'เริ่มจาก 3 แหล่ง: (1) directory ที่เปิดรีวิวและราคา เช่น Clutch, GoodFirms (2) รายชื่อสมาชิกสมาคมผู้ประกอบการปัญญาประดิษฐ์ประเทศไทย (AIEAT) (3) บทความเปรียบเทียบที่ตรวจเกณฑ์เองได้ เช่น บริษัทที่ปรึกษา AI ในไทย 2026 ของเรา — ก่อนคุยกับใคร ขอดู 3 อย่าง: ราคาเริ่มต้น เคสที่มีตัวเลข และใครเป็นเจ้าของ source code Hashbox เปิดทั้งสามไว้บนหน้านี้' ),
