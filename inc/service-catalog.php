...
function hashbox_service_catalog() {
    ...
    $catalog = array(
        ...
        'ai-search' => array(
            ...
            'desc'          => 'ประเมิน SEO + AI Search พร้อมลงมือแก้โครงสร้างเว็บและเนื้อหา เพิ่มโอกาสถูกค้นพบและอ้างอิง วัดผลถึงการติดต่อ ตามขอบเขตงานที่ตกลง',
            'en_desc'       => 'AEO/GEO assessment and scoped website implementation, with measurement of search visibility, citations and enquiries.',
            'service_type'  => 'Generative Engine Optimization',
            'stack'         => 'AEO / GEO · Technical SEO · Website implementation',
            'price'         => '',
            'price_llms'    => '',
            'accent'        => 'cyan',
            'featured'      => false,
