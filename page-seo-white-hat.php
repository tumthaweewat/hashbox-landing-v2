 ...
 *
 * ราคา: ใช้จุดเริ่มต้นเดียวกับหน้าแม่ (25,000 บาทต่อเดือน) ห้ามตั้งราคาใหม่ที่นี่ —
...
$desc         = 'รับทำ SEO สายขาวตามแนวทางของ Google — ไม่ซื้อลิงก์ ไม่ปั่นบทความ ไม่ cloaking · แก้ technical ก่อน ต่อด้วยคอนเทนต์ที่ตอบเจตนาและ GEO · ทุกงานตรวจย้อนได้ด้วยข้อมูลอันดับรายวันจากระบบของเราเอง · เริ่มต้น 25,000 บาทต่อเดือน เริ่มจาก SEO Audit ฟรี';
...
$faqs = array(
    array(
        ...
        'a' => 'ราคาเดียวกับบริการรับทำ SEO ของเรา คือเริ่มต้น 25,000 บาทต่อเดือน (ไม่รวม VAT 7%) เพราะ "สายขาว" ไม่ใช่แพ็กเกจพิเศษ แต่คือวิธีเดียวที่เรารับทำ ราคาจริงขึ้นกับ scope หลัง SEO Audit ฟรี — จำนวนหน้า สภาพ technical ปัจจุบัน ความยากของคีย์เวิร์ด และคู่แข่งในตลาด',
    ),
    array(
