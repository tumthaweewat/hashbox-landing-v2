...
$faqs = array(
    ...
    array(
        ...
        'a' => 'ถ้าใช้ n8n Community Edition แบบ self-host ภายใต้เงื่อนไขไลเซนส์ของ n8n จะไม่มีค่าสมาชิก n8n รายเดือน ยังมีค่าเซิร์ฟเวอร์ และอาจมีค่า API, บริการที่เชื่อมต่อ และค่าดูแลระบบตามการใช้งานจริง ซึ่งแยกจากค่าพัฒนาโปรเจกต์ แต่ฟีเจอร์ระดับองค์กรบางตัวเป็นของแพ็กเกจเสียเงินเท่านั้น — SSO, Projects, Environments (แยก dev/prod), log streaming และการผูกกับ Git ถ้าองค์กรคุณจำเป็นต้องใช้ฟีเจอร์เหล่านี้ เราจะบอกตั้งแต่ตอนคุย scope ไม่ปล่อยให้ไปเจอเองตอนใช้จริง',
    ),
    array(
    ...
    <div class="hb-container">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:var(--hb-space-4);">
            ...
            <div class="hb-card">
                ...
                <p class="hb-body" style="margin:0;"><strong>ก่อนออกใบเสนอราคา</strong> — ตกลงจำนวน workflow ระบบต้นทางและปลายทาง ความถี่ในการรัน ปริมาณข้อมูล กรณีผิดพลาดที่ต้องทดสอบ และผู้รับผิดชอบหลังส่งมอบ เพื่อแยกค่าพัฒนาออกจากค่าใช้จ่ายต่อเนื่องได้ชัดเจน</p>
        ...
        <p class="hb-body" style="margin-top:var(--hb-space-6);color:var(--hb-text-muted);"><?php echo esc_html( $price_from_txt ); ?> คือค่าพัฒนาเริ่มต้นต่อโปรเจกต์ แยกจากค่าเซิร์ฟเวอร์ ค่า API เช่น AI หรือข้อความที่คิดตามการใช้งาน ค่าสมาชิกบริการที่เชื่อมต่อ และค่าดูแลต่อเนื่องถ้าเลือกใช้ ไม่ใช่ราคาเหมาทุกงาน — เราเสนอราคาตาม scope จริงหลังคุย process และถ้าคุยแล้วเห็นว่างานของคุณยังไม่คุ้มที่จะทำเป็นระบบอัตโนมัติ เราจะบอกตรงๆ ก่อนที่คุณจะจ่ายอะไร · ราคาไม่รวม VAT 7%</p>
    </div>
</section>
